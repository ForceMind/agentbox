...
AgentBox source is the **pre-release `0.3.0rc12` development candidate** for
...
R12 software work is now in progress under the approved
[production-readiness plan](docs/project/PRODUCTION_READINESS_PLAN.md).
R12-B/rc11 delivers the fixed installer-owned API bootstrap profile through
[PR #90](https://github.com/ForceMind/agentbox/pull/90). The rc12 candidate adds
Runtime-only static-key custody and same-manifest binding; its
[validation record](docs/releases/0.3.0rc12.md) remains separate from full Runtime
provider/main composition, client installation and real-host qualification.
