...
[PR #90](https://github.com/ForceMind/agentbox/pull/90). R12-C1/rc12 delivers
Runtime-only static-key custody and same-manifest binding through
[PR #91](https://github.com/ForceMind/agentbox/pull/91). The rc13 candidate adds
