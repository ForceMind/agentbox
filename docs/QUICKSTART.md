...
advanced to the unqualified `0.3.0rc9` delivered software evidence; do not substitute
...
PR #85 completed rc9 exact-head CI, normal merge, merge read-back and post-main
validation. It remains neither an installable release nor a host qualification:
no tag, GitHub Release, production deployment or R12 host activation occurred.
