...
| R12-C | 进行中 | C1/rc12已合并；native auth-probe substrate于head`6148e95...`完成26项exact-head终态检查（24 success+2约定rc8 skip）与独立审查PASS；Python sealed lease/cache/executor、C3 main仍待推进 |
