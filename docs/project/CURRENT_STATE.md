...
- Real Linux host, PTY/devpts, Noise cryptography, WebSocket transport, browser terminal wiring, Codex attachment/CLI integration, Provider login, and WAW-3 continuity/recovery remain unverified/not implemented.
