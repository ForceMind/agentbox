...
rc8 已由 PR #83 完成交付：候选 c998 的实现证据和 710ceef 的文档 head
均完成 26 exact-head checks，normal merge 为
95bf65d6114008b962985f7311941499c961a7b8，六个 post-main workflow 全部
SUCCESS。它不构成 R12 或真实 host 资格。下一项是 rc9 全页面双语与
server-prose render fence，并要求 rc9 版本不会错误满足或破坏固定 rc8
artifact-operations gate。
